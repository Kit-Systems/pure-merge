...
class ControllerCatalogQuestion extends Controller {
	...
	protected function getList() {
		...
		$data['setting'] = $this->url->link('catalog/question/question_setting', 'user_token=' . $this->session->data['user_token'], true);
		...
		$data['sort_product'] = $this->url->link('catalog/question', 'user_token=' . $this->session->data['user_token'] . '&sort=pd.name' . $url, true);
		$data['sort_author'] = $this->url->link('catalog/question', 'user_token=' . $this->session->data['user_token'] . '&sort=r.author' . $url, true);
		
		$data['sort_status'] = $this->url->link('catalog/question', 'user_token=' . $this->session->data['user_token'] . '&sort=r.status' . $url, true);
		$data['sort_date_added'] = $this->url->link('catalog/question', 'user_token=' . $this->session->data['user_token'] . '&sort=r.date_added' . $url, true);
	...
	public function question_setting() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->response->redirect($this->url->link('catalog/question', 'user_token=' . $this->session->data['user_token'], true));
		}
		...
		$data['cancel'] = $this->url->link('catalog/question', 'user_token=' . $this->session->data['user_token'], true);
		...
		$this->response->setOutput($this->load->view('catalog/question_setting', $data));
	}
