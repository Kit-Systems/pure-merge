(function($) {
    ...
    let $deactivateForm  = jQuery('#instagram-feed-deactivateForm');
    ...
    let deactivateFormSubmitted = localStorage.getItem('instagram-feed-deactivateFormSubmitted');
    ...
    function submitForm(deactivate_options, id) {
        ...
        data.push({name: 'action', value: 'instagram-feed-deactivate'});
        ...
        if (!deactivateFormSubmitted) {
            localStorage.setItem('instagram-feed-deactivateFormSubmitted', true);
            deactivateFormSubmitted = true;

            jQuery.post('./controller/extension/module/elfsight_instagram_feed.php', jQuery.param(data)).then(function(result) {
