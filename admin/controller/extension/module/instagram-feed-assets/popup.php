<link rel="stylesheet" href="./controller/extension/module/instagram-feed-assets/popup.css">

<div class="eapps-deactivation-popup-overlay"></div>

<div class="eapps-deactivation-popup">
    <form method="post" id="instagram-feed-deactivateForm" action="">
        <div class="eapps-deactivation-popup-header">
            <div class="eapps-deactivation-popup-header-heading">You have succesfully uninstalled Elfsight Instagram Feed</div>
...
<script>
    ...
    node.async = true;
    node.src = './controller/extension/module/instagram-feed-assets/popup.js';
