...
class ControllerExtensionModuleCSVOcextDMPRO extends Controller {
	...
	private $error = array();
		...
		$this->document->setTitle(strip_tags($this->language->get('heading_title_'.$this->this_extension)));
		...
		$this->load->model('setting/setting');
			...
			$this->session->data['success'] = $this->language->get('text_success');
                        ...
                        if(isset($this->request->post['odmpro_update_csv_link'])){
                            ...
                            if(isset($this->request->post['odmpro_update_csv_smart_exchange_link'])){
                                ...
                                $this->model_tool_csv_ocext_dmpro->editSetting('odmpro_update_csv_smart_exchange_link', $this->request->post);
                ...
                if(isset($this->setting_version_settings['functional']['smart_exchange'])){
                    ...
                    $odmpro_update_csv_smart_exchange_link = $this->model_tool_csv_ocext_dmpro->getSetting('odmpro_update_csv_smart_exchange_link','odmpro_update_csv_smart_exchange_link');
  		...
  		$data['breadcrumbs'] = array();
   		...
   		$data['breadcrumbs'][] = array(
                    'text'      => $this->language->get('heading_title_'.$this->this_extension),
        ...
        public function getStepTwoSettings() {
            ...
            if($format_data=='csv'){
                ...
                if(isset($odmpro_tamplate_data['anyyml_yml_upload']) && $odmpro_tamplate_data['anyyml_yml_upload']){
