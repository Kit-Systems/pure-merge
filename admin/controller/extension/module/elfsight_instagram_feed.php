...
class Deactivate {
    ...
    public function __construct($data) {
        ...
        $this->app_slug = 'instagram-feed';
        $this->app_name = 'Instagram Feed';
    ...
    public function setDeactivateReasons() {
        return require ( (__DIR__) . '/instagram-feed-assets/reasons.php' );
    }
...
class ControllerExtensionModuleElfsightInstagramFeed extends Controller {
    private $error = array();

    public $params = NULL;

    const ELFSIGHT_EMBED_URL = 'https://apps.elfsight.com/embed/instashow/?utm_source=portals&utm_medium=opencart&utm_campaign=instagram-feed&utm_content=sign-up';

    public function index() {
        $this->load->language('extension/module/elfsight_instagram_feed');
        ...
        $data['action'] = $this->url->link('extension/module/elfsight_instagram_feed', 'user_token=' . $this->session->data['user_token'], true);
        ...
        $this->response->setOutput($this->load->view('extension/module/elfsight_instagram_feed', $data));
    }

    protected function validate() {
        if (!$this->user->hasPermission('modify', 'extension/module/elfsight_instagram_feed')) {
    ...
    public function setDeactivateReasons() {
        return require ( './controller/extension/module/instagram-feed-assets/reasons.php' );
    }
    ...
    public function uninstall() {
        ...
        include './controller/extension/module/instagram-feed-assets/popup.php';
    }
